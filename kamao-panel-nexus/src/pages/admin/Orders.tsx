...
const AdminOrders = () => {
  ...
  const handleSendReply = () => {
    if (selectedOrder && replyText.trim()) {
      addOrderReply(selectedOrder.id, replyText);
      setViewOpen(false);
    }
  };
      ...
      <Dialog open={viewOpen} onOpenChange={setViewOpen}>
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Order #{selectedOrder?.id.substring(0, 8)} - {selectedOrder && formatDate(selectedOrder.created_at)}
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="mt-1">{selectedOrder.reseller_name}</p>
                  <p className="text-sm text-gray-500">{selectedOrder.reseller_email}</p>
                </div>
                <div>
