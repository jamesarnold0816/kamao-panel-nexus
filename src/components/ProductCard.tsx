  ...
  return (
    <Card className="overflow-hidden h-full flex flex-col">
      <div className="relative h-48 overflow-hidden">
        ...
        />
        <Badge className={`absolute top-2 right-2 ${planColors[product.accessPlan]}`}>
          {product.accessPlan.charAt(0).toUpperCase() + product.accessPlan.slice(1)}
        </Badge>
      </div>
